...
Um die gemessenen Pt-100-Widerstände in die entsprechenden Temperaturen umzurechnen kann folgende Formel \cite{Anleitung} genutzt werden:
...
\begin{table}
    ...
    head=true,
    table head=$t \:/\: \si{\minute}$ & $R_P\:/\: \si{\kilo\ohm}$ &  $R_Z \:/\: \si{\kilo\ohm}$ & $ U \:/\: \si{\volt}$ & $I \:/\: \si{\milli\ampere}$\\ \midrule,
    late after line= \\]
    {datendat-copy.csv}{}{\csvcoli & \csvcolii & \csvcoliii & \csvcoliv& \csvcolv}
    \label{tab:C}
\end{table}
...
\begin{table}
    ...
    head=true,
    table head=$C_V \:/\: \si{\per\kelvin\per\mole}$ & $T \:/\: \si{\kelvin} $ &  $\frac{\theta_D}{T}$ \\ \midrule,
    late after line= \\]
    {C_v_und_T-copy.csv}{}{\csvcoli & \csvcolii & \csvcoliii}
    \label{tab:Debye}
\end{table}
