...
Damit lässt sich die innere Energie 
\begin{align*}
    U =  \int_0^{\omega_D} Z(\omega) \langle n(\omega)\rangle \hbar \omega d \omega=  \int_0^{\omega_D} \frac{Z(\omega) \hbar \omega d \omega}{\exp \left(\frac{\hbar \omega}{k_B T}\right) -1 \right)}
\end{align*}
\begin{align*}
    C_{V,\text{Debye}}&= \frac{d}{d T}\frac{9 N_L}{\omega_D^3} \int_0^{\omega_D} \frac{\omega^3 d\omega}{\exp \left(\frac{\hbar \omega}{k_B T}\right) -1 \right)}
\end{align*}
